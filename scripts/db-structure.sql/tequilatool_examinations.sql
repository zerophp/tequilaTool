...
CREATE TABLE `examinations` (
  ...
  KEY `fk_examinations_courses1_idx` (`courses_idcourses`),
  KEY `fk_examinations_exams1_idx` (`exams_idexams`),
  CONSTRAINT `fk_examinations_courses1` FOREIGN KEY (`courses_idcourses`) REFERENCES `courses` (`idcourses`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_examinations_exams1` FOREIGN KEY (`exams_idexams`) REFERENCES `exams` (`idexams`) ON DELETE NO ACTION ON UPDATE NO ACTION
