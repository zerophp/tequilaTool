...
CREATE TABLE `users_has_courses` (
  ...
  KEY `fk_users_has_courses_courses1_idx` (`courses_idcourses`),
  KEY `fk_users_has_courses_users1_idx` (`users_idusers`),
  CONSTRAINT `fk_users_has_courses_users1` FOREIGN KEY (`users_idusers`) REFERENCES `users` (`idusers`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_has_courses_courses1` FOREIGN KEY (`courses_idcourses`) REFERENCES `courses` (`idcourses`) ON DELETE NO ACTION ON UPDATE NO ACTION
