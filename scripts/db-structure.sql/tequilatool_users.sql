...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`idusers`),
  KEY `fk_users_status_idx` (`status_idstatus`),
  CONSTRAINT `fk_users_status` FOREIGN KEY (`status_idstatus`) REFERENCES `status` (`idstatus`) ON DELETE NO ACTION ON UPDATE NO ACTION
